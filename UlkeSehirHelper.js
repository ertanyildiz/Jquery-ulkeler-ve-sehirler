...
var BFHCountriesList = {
  'TR': 'Türkiye', 'US': 'Amerika Birleşik Devletleri', 'AF': 'Afganistan','AL': 'Arnavutluk','DZ': 'Cezayir','AS': 'Amerikan Samoası','AD': 'Andorra','AO': 'Angola','AI': 'Anguilla','AQ': 'Antartika','AG': 'Antigua ve Barbuda','AR': 'Arjantin','AM': 'Ermenistan','AW': 'Aruba','AU': 'Avustralya','AT': 'Avusturya','AZ': 'Azerbaycan','BH': 'Bahreyn','BD': 'Bangladeş','BB': 'Barbados','BY': 'Beyaz Rusya','BE': 'Belçika','BZ': 'Belize','BJ': 'Benin','BM': 'Bermuda','AE': 'Birleşik Arap Emirlikleri','GB': 'Birleşik Krallık','BT': 'Butan','BO': 'Bolivya','BA': 'Bosna Hersek','BW': 'Botswana','BV': 'Bouvet Adası','BR': 'Brezilya','IO': 'İngiliz Hint Okyanusu Bölgesi','VG': 'İngiliz Virgin Adaları','BN': 'Brunei','BG': 'Bulgaristan','BF': 'Burkina Faso','BI': 'Burundi','CI': 'Côte d" Ivoire ','KH': 'Kamboçya','CM': 'Kamerun','CA': 'Kanada','CV': 'Cape Verde','KY': 'Cayman Islands','CF': 'Orta Afrika Cumhuriyeti','TD': 'Çad','CL': 'Şili','CN': 'Çin','CX': 'Noel Adası','CC': 'Cocos (Keeling) Adaları','CO': 'Kolombiya','KM': 'Komor','CG': 'Kongo','CK': 'Cook Adaları','CR': 'Kosta Rika','İK': 'Hırvatistan','CU': 'Küba','CY': 'Kıbrıs','CZ': 'Çek Cumhuriyeti','CD': 'Demokratik Kongo Cumhuriyeti','DK': 'Danimarka','DJ': 'Cibuti','DM': 'Dominika','DO': 'Dominik Cumhuriyeti','TP': 'Doğu Timor','EC': 'Ekvator','EG': 'Mısır','SV': 'El Salvador','GQ': 'Ekvator Ginesi','ER': 'Eritrea','EE': 'Estonya','ET': 'Etiyopya','FO': 'Faeroe Adaları','FK': 'Falkland Adaları','FJ': 'Fiji','FI': 'Finlandiya','MK': 'Eski Yugoslav Makedonya Cumhuriyeti','FR': 'Fransa','FX': 'Fransa, Metropolitan','GF': 'Fransız Guyanası','PF': 'Fransız Polinezyası','TF': 'Fransız Güney Bölgeleri','GA': 'Gabon','GE': 'Gürcistan','DE': 'Almanya','GH': 'Gana','GI': 'Cebelitarık','GR': 'Yunanistan','GL': 'Grönland','GD': 'Grenada','GP': 'Guadeloupe','GU': 'Guam','GT': 'Guatemala','GN': 'Gine','GW': 'Gine-Bissau','GY': 'Guyana','HT': 'Haiti','HM': 'Heard ve Mc Donald Adaları','HN': 'Honduras','HK': 'Hong Kong','HU': 'Macaristan','IS': 'İzlanda','IN': 'Hindistan','ID': 'Endonezya','IR': 'İran','IQ': 'Irak','IE': 'İrlanda','IL': 'İsrail','IT': 'İtalya','JM': 'Jamaika','JP': 'Japonya','JO': 'Ürdün','KZ': 'Kazakistan','KE': 'Kenya','KI': 'Kiribati','KW': 'Kuwait','KG': 'Kırgızistan','LA': 'Laos','LV': 'Letonya','LB': 'Lübnan','LS': 'Lesotho','LR': 'Liberya','LY': 'Libya','LI': 'Lihtenştayn','LT': 'Litvanya','LU': 'Lüksemburg','MO': 'Makao','MG': 'Madagaskar','MW': 'Malavi','MY': 'Malezya','MV': 'Maldivler','ML': 'Mali','MT': 'Malta','MH': 'Marshall Adaları','MQ': 'Martinik','MR': 'Moritanya','MU': 'Mauritius','YT': 'Mayotte','MX': 'Meksika','FM': 'Mikronezya','MD': 'Moldova','MC': 'Monaco','MN': 'Moğolistan','ME': 'Karadağ','MS': 'Montserrat','MA': 'Fas','MZ': 'Mozambik','MM': 'Myanmar','NA': 'Namibya','NR': 'Nauru','NP': 'Nepal','NL': 'Hollanda','AN': 'Hollanda Antilleri','NC': 'Yeni Kaledonya','NZ': 'Yeni Zelanda','NI': 'Nikaragua','NE': 'Nijer','NG': 'Nijerya','NU': 'Niue','NF': 'Norfolk Adası','KP': 'Kuzey Kore','MP': 'Kuzey Marianas','NO': 'Norveç','OM': 'Umman','PK': 'Pakistan','PW': 'Palau','PS': 'Filistin','PA': 'Panama','PG': 'Papua Yeni Gine','PY': 'Paraguay','PE': 'Peru','PH': 'Filipinler','PN': 'Pitcairn Adaları','PL': 'Polonya','PT': 'Portekiz','PR': 'Porto Riko','KG': 'Katar','RE': 'Reunion','RO': 'Romanya','RU': 'Rusya','RW': 'Ruanda','ST': 'São Tomé ve Príncipe','SH': 'Saint Helena','PM': 'St. Pierre ve Miquelon ','KN': 'Saint Kitts and Nevis','LC': 'Saint Lucia','VC': 'Saint Vincent ve Grenadinler','WS': 'Samoa','SM': 'San Marino','SA': 'Suudi Arabistan','SN': 'Senegal','SC': 'Sırbistan','SC': 'Seyşeller','SL': 'Sierra Leone','SG': 'Singapur','SK': 'Slovakya','SI': 'Slovenya','SB': 'Solomon Adaları','SO': 'Somali','ZA': 'Güney Afrika','GS': 'Güney Georgia ve Güney Sandviç Adaları','KR': 'Güney Kore','ES': 'İspanya','LK': 'Sri Lanka','SD': 'Sudan','SR': 'Surinam','SJ': 'Svalbard ve Jan Mayen Adaları','SZ': 'Svaziland','SE': 'İsveç','CH': 'İsviçre','SY': 'Suriye','TW': 'Tayvan','TJ': 'Tacikistan','TZ': 'Tanzanya','TH': 'Tayland',
'BS':'Bahamalar',
'GM': 'Gambiya',
'TG': 'Togo',
'TK': 'Tokelau',
